  ...
  return (
    <>
      <div className="h-[50vh] md:h-[70.3vh] flex flex-col items-center justify-center bg-white">
        ...
        <div>
          <div className="absolute top-[calc(50%-125px)] md:top-[calc(50%-50px)] left-1/2 -translate-x-[50%] -translate-y-1/2 w-[260px] h-[260px] md:w-[360px] md:h-[360px] animate-spin-faster rotate-190 border-3 border-[#A0A4AB] border-dotted opacity-20"></div>
          <div className="absolute top-[calc(50%-125px)] md:top-[calc(50%-50px)] left-1/2 -translate-x-[50%] -translate-y-1/2 w-[240px] h-[240px] md:w-[340px] md:h-[340px] animate-spin-faster rotate-185 border-3 border-[#A0A4AB] border-dotted opacity-30"></div>
          <div className="absolute top-[calc(50%-125px)] md:top-[calc(50%-50px)] left-1/2 -translate-x-[50%] -translate-y-1/2 w-[220px] h-[220px] md:w-[320px] md:h-[320px] animate-spin-fast border-3 border-[#A0A4AB] border-dotted opacity-40"></div>
        </div>
      </div>
