...
const DiamondsDesktopRight = () => {
  return (
    <>
      ...
      <button className="hidden lg:inline-flex items-center justify-center gap-4 whitespace-nowrap rounded-md text-sm font-normal text-[#1A1B1C] transition-colors focus-visible:outline-none focus-visible:ring-1 cursor-pointer disabled:opacity-50 h-9 absolute top-1/2 right-10 -translate-y-[-30px] translate-x-[-60px] px-3 py-1">
        <span>TAKE TEST</span>
